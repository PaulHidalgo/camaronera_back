...
app.put('/usuario/:id', [verificaToken, verficaAdminRole], function(req, res) {
...
//app.post('/usuario', [verificaToken, verficaAdminRole], function(req, res) {
...
app.delete('/usuario/:id', [verificaToken, verficaAdminRole], function(req, res) {
    let id = req.params.id;
    let cambioEstado = {
        estado: false
    };
